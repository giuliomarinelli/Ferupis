...
export const CircleCheckRegularIcon = component$<IconProps>(({ class: className }) => (
    <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 672 672" class={['fill-current', className ?? '']}>
        {/* <!--!Font Awesome Pro v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2026 Fonticons, Inc.--> */}
        <path d="M320 576C178.6 576 64 461.4 64 320C64 178.6 178.6 64 320 64C461.4 64 576 178.6 576 320C576 461.4 461.4 576 320 576zM320 112C205.1 112 112 205.1 112 320C112 434.9 205.1 528 320 528C434.9 528 528 434.9 528 320C528 205.1 434.9 112 320 112zM443.7 242.8L429.6 262.2L307.5 430.1L291 452.8L198.3 360.1L232.2 326.2L285.2 379.2L390.8 234L404.9 214.6L443.7 242.8z" />
    </svg>
))
