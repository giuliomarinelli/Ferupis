/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example` (hash: 6b3e4869cb13a58b4aee7cb57386fc3c)
...
interface __BaseEnv_Env {
	...
	SITE_ORIGIN: "https://preview.ferupis.pages.dev" | "https://ferupis.pages.dev" | "http://localhost:8788";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "EMAIL_DELIVERY_MODE" | "EMAIL_FROM" | "EMAIL_REPLY_TO" | "SITE_ORIGIN" | "RESEND_API_KEY">> {}
}
