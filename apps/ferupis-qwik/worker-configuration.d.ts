/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d139492f9ff8608ce982d810c518eab3)
// Runtime types generated with workerd@1.20260815.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	EMAIL_QUEUE: Queue;
	APP_ENV: "preview" | "production" | "dev";
	CF_TURNSTILE_SITE_KEY: "0x4AAAAAAEjzAO2pfq4Q2514" | "<CF_TURNSTILE_SITE_KEY_PRODUCTION>" | "1x00000000000000000000BB";
}
declare namespace Cloudflare {
	interface PreviewEnv {
		EMAIL_QUEUE: Queue;
		APP_ENV: "preview";
		CF_TURNSTILE_SITE_KEY: "0x4AAAAAAEjzAO2pfq4Q2514";
	}
	interface ProductionEnv {
		EMAIL_QUEUE: Queue;
		APP_ENV: "production";
		CF_TURNSTILE_SITE_KEY: "<CF_TURNSTILE_SITE_KEY_PRODUCTION>";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CF_TURNSTILE_SITE_KEY">> {}
}
